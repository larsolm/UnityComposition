namespace PiRhoSoft.CompositionEngine
{
	public class DivideOperator : InfixOperation
	{
		...
		public static VariableValue Divide(ref VariableValue left, ref VariableValue right)
		{
			switch (right.Type)
			{
				case VariableType.Integer:
				{
					...
					switch (left.Type)
					{
						case VariableType.Integer: return VariableValue.Create((float)left.Integer / right.Integer);

...
{
	public class IsolatedVariableCollection : IVariableMap
	{
		private IVariableMap _parent;
		private VariableDictionary _self = new VariableDictionary();

		public IsolatedVariableCollection(IVariableMap parent)
		{
			_parent = parent;
		}

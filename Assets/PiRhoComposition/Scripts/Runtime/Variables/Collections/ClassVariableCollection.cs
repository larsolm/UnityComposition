...
namespace PiRhoSoft.Composition
{
	...
	public class ClassVariableCollection : IVariableArray, IVariableMap
	{
		private object _owner;
		private ClassVariableMap _map;

		public ClassVariableCollection(object owner)
		{
			_owner = owner;
			_map = ClassVariableMap.Get(owner.GetType());
		}
	...
	public abstract class ClassVariableMap
	{
		private static Dictionary<Type, ClassVariableMap> _maps = new Dictionary<Type, ClassVariableMap>();
		...
		public static void Add<T>(ClassVariableMap<T> map)
		{
			_maps.Add(typeof(T), map);
		}

		public static ClassVariableMap Get(Type type)
		{
			if (!_maps.TryGetValue(type, out ClassVariableMap map) && Configuration.AutoCreateVariableMaps)
			{
		...
		public static bool TryGet(Type type, out ClassVariableMap map)
		{
		...
		protected void AddProperties(ClassVariableMap map)
		{
		...
		private class ReflectedMap : ClassVariableMap
		{
			public ReflectedMap(Type type)
			{
				...
				// be better from a performance perspective to implement IVariableMap directly.
	...
	public abstract class ClassVariableMap<T> : ClassVariableMap
	{

...
namespace PiRhoSoft.Composition.Editor
{
	...
	public class GraphViewEditor : VisualElement
	{
		...
		public const string Stylesheet = "Graph/GraphView/GraphViewStyle.uss";
		...
		{
			var type = (CurrentGraph ? (CurrentGraph.Context.Constraint as ObjectConstraint)?.ObjectType : null) ?? typeof(GameObject);

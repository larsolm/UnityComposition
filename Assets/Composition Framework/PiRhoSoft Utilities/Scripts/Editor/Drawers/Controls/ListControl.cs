...
namespace PiRhoSoft.UtilityEditor
{
	...
	public abstract class ListControl
	{
		...
		private static Label _expandButton = new Label(Icon.Collapsed, string.Empty, "Expand the contents of this list");
		private static Label _collapseButton = new Label(Icon.Expanded, string.Empty, "Collapse the contents of this list");

...
namespace PiRhoSoft.Composition.Editor
{
	public class VariableSchemaEntryControl : VisualElement
	{
		...
		private PopupField<string> _tagPopup;
		private IconButton _modeToggle;
		private VisualElement _initializer;

		private bool _advancedMode = false;

		public VariableSchemaEntryControl(TagList tags, VariableSchema.Entry value)
		{
			Value = value;
			Tags = tags;
		...
		private void Refresh()
		{
			...
			_tagPopup = new PopupField<string>("Tag", Tags.List, Value.Tag);
		...
		private VisualElement CreateInitializer()
		{

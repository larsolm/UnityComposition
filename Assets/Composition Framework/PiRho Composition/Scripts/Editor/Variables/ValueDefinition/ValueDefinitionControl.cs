...
namespace PiRhoSoft.Composition.Editor
{
	public class ValueDefinitionControl : VisualElement
	{
		...
		public ValueDefinitionControl(ValueDefinition value, VariableInitializerType initializer, TagList tags, bool showConstraintLabel)
		{
			Value = Value;
		...
		public void SetValueWithoutNotify(ValueDefinition value)
		{
			Value = value;
			Refresh();
		}
		...
		private void SetupType()
		{
			...
			dropdown.RegisterValueChangedCallback(evt =>
			{
				...
				var value = ValueDefinition.Create(type, constraint, Value.Tag, Value.Initializer, Value.IsTypeLocked, Value.IsConstraintLocked);
		...
		private void SetupTag()
		{
			...
			if (Tags != null && Tags.Count > 0)
			{
				...
				dropdown.RegisterValueChangedCallback(evt =>
				{
					var value  = ValueDefinition.Create(Value.Type, Value.Constraint, evt.newValue, Value.Initializer, Value.IsTypeLocked, Value.IsConstraintLocked);
					SetValue(value);
				});

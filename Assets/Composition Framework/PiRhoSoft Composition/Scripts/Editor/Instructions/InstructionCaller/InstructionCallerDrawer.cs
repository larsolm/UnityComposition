...
namespace PiRhoSoft.CompositionEditor
{
	...
	{
		private readonly static Label _refreshButton = new Label(Icon.Refresh, "", "Refresh the list of inputs and outputs");
	...
	public class InstructionCallerDrawer : PropertyDrawer<InstructionCallerControl>
	{
		public override VisualElement CreatePropertyGUI(SerializedProperty property)
		{
			...
			var caller = new InstructionCallerElement();
			caller.Setup(property);

			container.Add(caller);

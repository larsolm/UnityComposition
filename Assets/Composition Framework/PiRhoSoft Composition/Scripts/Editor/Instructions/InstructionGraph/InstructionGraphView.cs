...
namespace PiRhoSoft.CompositionEditor
{
	...
	public class InstructionGraphProvider : PickerProvider<InstructionGraph> { }
	...
	public class InstructionGraphViewEditor : VisualElement
	{
		...
		{
			_window = window;
			_graphProvider = ScriptableObject.CreateInstance<InstructionGraphProvider>();
		...
		{
			var graphs = AssetHelper.GetAssetList<InstructionGraph>();

			_graphProvider.Setup("Select Graph", graphs.Paths, graphs.Assets.Cast<InstructionGraph>().ToList(), graph => AssetPreview.GetMiniThumbnail(graph), selectedGraph => SetGraph(selectedGraph));
		...
		{
			InstructionGraph.IsDebugBreakEnabled = !InstructionGraph.IsDebugBreakEnabled;
			_breakpointsEnabled.Value = InstructionGraph.IsDebugBreakEnabled;
		}

		private void ToggleLoggingEnabled()
		{
			InstructionGraph.IsDebugLoggingEnabled = !InstructionGraph.IsDebugLoggingEnabled;

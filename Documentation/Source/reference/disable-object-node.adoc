...
NOTE: To deactivate a https://docs.unity3d.com/ScriptReference/GameObject.html[GameObject^] from a https://docs.unity3d.com/ScriptReference/Component.html[Component^] reference use `as GameObject` (see the <<topics/variables-4.html,Accessing Variables>> topic).

...
NOTE: This interface is one of the most important pieces to the variable system. Read the <<topics/variables.html,variables topic>> for a complete description of this interface and how it interacts with the rest of the system.

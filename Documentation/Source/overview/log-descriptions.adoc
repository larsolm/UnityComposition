...
When dealing with <<topics/variables/accessing-variables.html,VariableReference>> errors, the <<topics/graphs/debugging.html,Watch Window>> can be extremely useful. Global variables can be investigated at any time and variables on a specific <<topics/graphs/overview.html,InstructionGraph>> can be investigated by <<topics/graphs/debugging.html,setting a breakpoint>> on a node.

<<topics/variables/writing-expressions.html,Expression>> errors can be harder to track down. If the text box containing the <<topics/variables/writing-expressions.html,Expression>> is red, the issue is with the actual structure of the <<topics/variables/writing-expressions.html,Expression>> and details will be displayed. In this case the error state will update as the <<topics/variables/writing-expressions.html,Expression>> is modified so it is easy to see when the issue has been resolved. If the <<topics/variables/writing-expressions.html,Expression>> is valid and an error is printed at runtime, the issue is usually related to a <<topics/variables/accessing-variables.html,VariableReference>> and the above tip for using the <<topics/graphs/debugging.html,Watch Window>> applies.
...
| {1} | The <<topics/variables/accessing-variables.html,VariableReference>> assigned to _Target_ that resolved to an invalid type.
|===
...
Resolution:: If the reported error ({2}) indicates a parameter is invalid, the _Condition_ <<topics/variables/writing-expressions.html,Expression>> is calling the command incorrectly. Otherwise, the command itself has an error and needs to be edited directly. The message should provide details on how to go about fixing the issue.
...
|===
| {0} | The <<manual/enable-binding.html,EnableBinding>> that triggered the warning.
| {1} | The statement in the _Condition_ <<topics/variables/writing-expressions.html,Expression>> that failed.
| {2} | The error message reported by the expression.
|===

Effect:: The enabled state of _Object_ will not be changed.

Resolution:: The reported error ({2}) should provide details on how to go about fixing the _Condition_ <<topics/variables/writing-expressions.html,Expression>>.
...
|===
| {0} | The <<manual/enable-binding.html,EnableBinding>> that triggered the warning.
| {1} | The final statement in the _Condition_ <<topics/variables/writing-expressions.html,Expression>>.
|===
...
Resolution:: Set the _Condition_ <<topics/variables/writing-expressions.html,Expression>>.
...
[cols="1,8"]
|===
| {0} | The https://docs.unity3d.com/ScriptReference/Object.html[Object^] that executed the <<topics/variables/writing-expressions.html,Expression>>.
| {1} | The final statement of the <<topics/variables/writing-expressions.html,Expression>> that was expected to result in a specific type.
| {2} | The <<topics/variables/creating-variables.html,VariableType>> the caller expected from the result of the expression.
| {3} | The actual <<topics/variables/creating-variables.html,VariableType>> of the result of the expression.
|===
...
Resolution:: If the reported error ({2}) indicates a parameter is invalid, the _Expression_ <<topics/variables/writing-expressions.html,Expression>> is calling the command incorrectly. Otherwise, the command itself has an error and needs to be edited directly. The message should provide details on how to go about fixing the issue.
...
|===
| {0} | The <<manual/expression-binding.html,ExpressionBinding>> that triggered the warning.
| {1} | The statement in the _Expression_ <<topics/variables/writing-expressions.html,Expression>> that failed.
| {2} | The error message reported by the expression.
|===

Effect:: The http://digitalnativestudios.com/textmeshpro/docs/[TMP_Text^] will be hidden and cleared.

Resolution:: The reported error ({2}) should provide details on how to go about fixing the _Expression_ <<topics/variables/writing-expressions.html,Expression>>.
...
Resolution:: Set the _Expression_ <<topics/variables/writing-expressions.html,Expression>>.
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to an invalid <<topics/variables/creating-variables.html,VariableType>>.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it either resolves to a variable with the correct type or resolves to a variable that can be assigned any type.
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to an invalid enum type.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it resolves to a variable with the correct enum type.
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to an invalid object type.
| {1} | The <<manual/instruction-graph-node.html,InstructionGraphNode>> that attempted to resolve the variable.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it resolves to a variable with the correct object type.
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to an invalid type.
| {1} | The <<manual/instruction-graph-node.html,InstructionGraphNode>> that attempted to resolve the variable.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it resolves to a variable with the correct type.
...
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to an invalid <<topics/variables/creating-variables.html,VariableType>>.
| {1} | The <<manual/instruction-graph-node.html,InstructionGraphNode>> that attempted to resolve the variable.
| {2} | The <<topics/variables/creating-variables.html,VariableType>> of the resolved value.
| {3} | The <<topics/variables/creating-variables.html,VariableType>> the <<manual/instruction-graph-node.html,InstructionGraphNode>> expected.
|===
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that could not be resolved.
| {1} | The <<manual/instruction-graph-node.html,InstructionGraphNode>> that attempted to assign to the variable.
|===

Effect:: The assignment will not be performed.

Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it resolves to a valid variable.
...
[cols="1,8"]
|===
| {0} | The <<topics/variables/accessing-variables.html,VariableReference>> that resolved to a read only variable.
| {1} | The <<manual/instruction-graph-node.html,InstructionGraphNode>> that attempted to assign to the variable.
|===

Effect:: The assignment will not be performed.

Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/instruction-graph-node.html,InstructionGraphNode>> so it resolves to a writable variable.
...
[cols="1,8"]
|===
| {0} | The format of the <<topics/interface/messages.html,Message>> that is being resolved.
| {1} | The <<topics/variables/accessing-variables.html,VariableReference>> that could not be found.
|===

Effect:: The text of the message will have the failed section omitted.

Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> in the <<topics/interface/messages.html,Message>> to a valid variable.
...
Resolution:: If the effect of disabling the http://digitalnativestudios.com/textmeshpro/docs/[TMP_Text^] is desired, set _Suppress Errors_ on the <<manual/number-binding.html,NumberBinding>>. Otherwise, change the <<topics/variables/accessing-variables.html,VariableReference>> to a valid variable.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> to a variable that resolves to either an `Int` or `String`.

#### CUSNLS

Unable to unload scene on node '{0}': the scene '{1}' is the only loaded scene

[cols="1,8"]
|===
| {0} | The <<manual/unload-scene-node.html,UnloadSceneNode>> that attempted to unload the scene.
| {1} | The name or build index of the scene that is the only loaded scene and could therefore not be unloaded.
|===

Effect:: No scenes will be unloaded and the <<manual/unload-scene-node.html,UnloadSceneNode>> will complete immediately.

Resolution:: Load a different scene in non additive mode rather than unloading the scene.

#### CUSNUI

Unable to unload scene on node '{0}': the scene with index '{1}' is not loaded

[cols="1,8"]
|===
| {0} | The <<manual/unload-scene-node.html,UnloadSceneNode>> that attempted to unload the scene.
| {1} | The build index of the scene that is not loaded and could therefore not be unloaded.
|===

Effect:: No scenes will be unloaded and the <<manual/unload-scene-node.html,UnloadSceneNode>> will complete immediately.

Resolution:: Change the scene index to a scene that is currently loaded.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it either resolves to a variable with the correct type or resolves to a variable that can be assigned any type.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it resolves to a variable with the correct enum type.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it resolves to a variable with the correct object type.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it resolves to a variable with the correct type.
...
| {1} | The <<manual/variable-binding.html,VariableBinding>> that attempted to resolve the variable.
| {2} | The <<topics/variables/creating-variables.html,VariableType>> of the resolved value.
| {3} | The <<topics/variables/creating-variables.html,VariableType>> the <<manual/variable-binding.html,VariableBinding>> expected.
|===
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it resolves to a valid variable.
...
Resolution:: Change the <<topics/variables/accessing-variables.html,VariableReference>> on the <<manual/variable-binding.html,VariableBinding>> so it resolves to a writable variable.
...
[cols="1,8"]
|===
| {0} | The variable that was entered in the <<topics/graphs/debugging.html,watch window>>.
| {1} | The <<topics/variables/creating-variables.html,VariableType>> of the variable that was entered.
|===

Effect:: The variable will not be added to the watch window.

Resolution:: This only happens in the editor as a result of entering an invalid variable in the manual entry of the <<topics/graphs/debugging.html,watch window>>.
...
[cols="1,8"]
|===
| {0} | The command called from an <<topics/variables/writing-expressions.html,Expression>> that failed.
| {1} | The https://docs.unity3d.com/ScriptReference/Object.html[Object^] that initiated execution of the <<topics/variables/writing-expressions.html,Expression>>.
| {2} | The error message from the failed command.
|===

Effect:: Execution of the <<topics/variables/writing-expressions.html,Expression>> that called the command will stop and result in an empty variable.
...
[cols="1,8"]
|===
| {0} | The statement in the <<topics/variables/writing-expressions.html,Expression>> that failed.
| {1} | The https://docs.unity3d.com/ScriptReference/Object.html[Object^] that initiated execution of the <<topics/variables/writing-expressions.html,Expression>>.
| {2} | The error message from the failed comman<<topics/variables/writing-expressions.html,Expression>>.
|===

Effect:: Execution of the <<topics/variables/writing-expressions.html,Expression>> will stop and result in an empty variable.

Resolution:: The content of the error message should help explain what needs to be fixed in the <<topics/variables/writing-expressions.html,Expression>>.
...
[cols="1,8"]
|===
| {0} | The keyword that was attempted to be added to the <<topics/variables/writing-expressions.html,Expression>> system.
|===
...
[cols="1,8"]
|===
| {0} | The constant that was attempted to be added to the <<topics/variables/writing-expressions.html,Expression>> system.
|===
...
[cols="1,8"]
|===
| {0} | The command that was attempted to be added to the <<topics/variables/writing-expressions.html,Expression>> system.
|===
...
[cols="1,8"]
|===
| {0} | The symbol for the operator that was attempted to be added to the <<topics/variables/writing-expressions.html,Expression>> system.
|===
...
[cols="1,8"]
|===
| {0} | The full text of the <<topics/variables/writing-expressions.html,Expression>> that could not be parsed.
| {1} | The character index in the <<topics/variables/writing-expressions.html,Expression>> text where the error happened.
| {2} | The token in the <<topics/variables/writing-expressions.html,Expression>> text where the error happened.
| {3} | Details about the error.
|===

Effect:: The <<topics/variables/writing-expressions.html,Expression>> will not be executable.

Resolution:: Fix the structure of the <<topics/variables/writing-expressions.html,Expression>> based on the details given in the error message.
...
| {2} | The value that was sent to the <<manual/instruction.html,Instruction>> as the context but didn't match the <<topics/variables/creating-variables.html,constraint>>.
|===
...
| {2} | The value that was sent to the <<manual/instruction.html,Instruction>> for the input but didn't match the <<topics/variables/creating-variables.html,constraint>>.
|===
...
| {2} | The <<topics/variables/creating-variables.html,variable>> that the <<manual/instruction.html,Instruction>> attempted to assign the output to.
|===

Effect:: The output will not be assigned.

Resolution:: Either change the <<topics/variables/creating-variables.html,variable>> the output is assigned to to one with a compatible type or one that can be set to any value, or set the output to be ignored.
...
| {0} | The name of the input variable that failed as set on the <<manual/instruction.html,Instruction>>.
| {1} | The <<manual/instruction.html,Instruction>> that failed to store the output.
| {2} | The <<topics/variables/creating-variables.html,variable>> that the <<manual/instruction.html,Instruction>> attempted to read the input from.
|===

Effect:: The <<manual/instruction.html,Instruction>> will still run, but the input will be empty.

Resolution:: Either change the <<topics/variables/creating-variables.html,variable>> the input is read from or change the input to a specific value.
...
Unable to load scene on node '{0}': the index '{1}' is not a valid scene - make sure the scene has been added to the build settings";

[cols="1,8"]
|===
| {0} | The <<manual/load-scene-node.html,LoadSceneNode>> that attempted to load the scene.
| {1} | The build index of the scene that could not be found.
|===

Effect:: No scenes will be loaded or unloaded and the <<manual/load-scene-node.html,LoadSceneNode>> will complete immediately.

Resolution:: Change the build index to a valid scene that has been added to the project's build settings.

#### CLSNIN

Unable to load scene on node '{0}': the name '{1}' is not a valid scene - make sure the scene exists and has been added to the build settings";

[cols="1,8"]
|===
| {0} | The <<manual/load-scene-node.html,LoadSceneNode>> that attempted to load the scene.
| {1} | The name of the scene that could not be found.
|===

Effect:: No scenes will be loaded or unloaded and the <<manual/load-scene-node.html,LoadSceneNode>> will complete immediately.

Resolution:: Make sure the scene name is a valid scene that has been added to the project's build settings.
...
| {2} | The <<topics/variables/creating-variables.html,variable>> specified on the item that is not a `List`.
|===

Effect:: The item will not be added to the <<topics/interface/menus-and-selections.html,menu>>.

Resolution:: Either change _Variables_ on the <<topics/interface/menus-and-selections.html,menu item>> so it refers to a `List` value or disable _Expand_ on the <<topics/interface/menus-and-selections.html,menu item>>
...
| {1} | The name of the <<manual/selection-control.html,SelectionControl>>.
| {2} | The <<topics/variables/creating-variables.html,variable>> specified on the item that is not a `Store` or `List`.
|===

Effect:: The item will not be added to the <<topics/interface/menus-and-selections.html,menu>>.

Resolution:: Change _Variables_ on the <<topics/interface/menus-and-selections.html,menu item>> so it refers to a `Store` or `List`.
...
| {0} | The name of the item sent to the <<manual/selection-control.html,SelectionControl>> that could not be expanded.
| {1} | The name of the <<manual/selection-control.html,SelectionControl>>.
| {2} | The <<topics/variables/creating-variables.html,variable>> specified on the item that could not be resolved.
|===
...
Resolution:: Assign _Template_ on the <<topics/interface/menus-and-selections.html,menu item>>.
...
Unable to unload scene on node '{0}': the index '{1}' is not a valid scene - make sure the scene has been added to the build settings
...
Resolution:: Change the build index to a valid scene or add the specified scene to the project's build settings.

#### CUSNIN

Unable to unload scene on node '{0}': a scene with name '{1}' is not loaded - make sure the scene exists and has been added to the build settings";

[cols="1,8"]
|===
| {0} | The <<manual/unload-scene-node.html,UnloadSceneNode>> that attempted to unload the scene.
| {1} | The name of the scene that could not be found in the set of loaded scenes.
|===

Effect:: No scenes will be unloaded and the <<manual/unload-scene-node.html,UnloadSceneNode>> will complete immediately.

Resolution:: Make sure the scene name is a valid scene that is loaded and has been added to the project's build settings.
...
| {1} | The <<topics/variables/creating-variables.html,type>> the definition was given.
| {2} | The <<topics/variables/creating-variables.html,type>> the definition's initializer evaluated to.
|===

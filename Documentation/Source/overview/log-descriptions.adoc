...
Failed to expand item '{0}' on SelectionControl '{1}': the variable '{2}' is not an IVariableList
...
Failed to create item '{0}' on SelectionControl '{1}': the variable '{2}' is not an IVariableStore or IVariableList
